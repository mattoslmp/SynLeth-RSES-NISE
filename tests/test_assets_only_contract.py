...
def test_complete_wrapper_executes_extended_circos_and_finalization() -> None:
  ...
  required = {
    ...
    "enrich_genomic_circos_internal_layers.py",
    "complete_genomic_circos_expression_summary.py",
    "complete_genomic_circos_links.py",
    "finalize_genomic_circos_status.py",
    "validate_genomic_circos_final_status.py",
    "make_genomic_circos_figure_resilient.py",
    "register_genomic_circos_assets.py",
    "build_genomic_circos_methods.py",
    "catalog_figure_source_data.py",
    "validate_genomic_circos_integrity.py",
